...
import com.noinnion.android.newsplus.extension.inoreader.util.Utils;
...
public class InoReaderClient extends ReaderExtension {
	...
	public InoReaderClient(Context c) {
		mContext = c;
	}
