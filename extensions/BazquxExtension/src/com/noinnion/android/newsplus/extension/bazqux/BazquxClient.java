...
import com.noinnion.android.newsplus.extension.bazqux.util.Utils;
...
public class BazquxClient extends ReaderExtension {

	public static final String	TAG								= "BazquxClient";

	public static final String	URL_LOGIN						= "https://bazqux.com/accounts/ClientLogin";
	public static final String	URL_BASE_						= "https://bazqux.com/reader";
...
//		Log.d(TAG, "[DEBUG] Authorization: " + "GoogleLogin auth=" + this.auth);
	...
	private String initAuth() throws IOException, ReaderException {
		...
		if (TextUtils.isEmpty(this.loginId)) this.loginId = Prefs.getGoogleId(context);
		if (TextUtils.isEmpty(this.password)) this.password = Prefs.getGooglePasswd(context);
	...
	public String getUserId() throws IOException, ReaderException {
		String userId = null;
		InputStream in = doGetInputStream(URL_API_USER_INFO);
		try {
